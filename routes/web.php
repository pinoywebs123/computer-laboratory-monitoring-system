...
Route::get('/staff-settings', [
	'as'=> 'settings',
	'uses'=> 'staff@settings'
]);
Route::post('/staff-change-settings', [
	'as'=> 'staff_change_settings',
	'uses'=> 'staff@staff_change_settings'
]);
Route::post('/staff-change-info', [
	'as'=> 'staff_change_info',
	'uses'=> 'staff@staff_change_info'
]);
...
Route::get('/admin-pc/{pc_id}/{room}', [
	'as'=> 'pc_delete',
	'uses'=> 'admin@pc_delete'
]);
...
Route::get('/admin-student/edit/{student_id}', [
	'as'=> 'admin_edit_student',
	'uses'=> 'admin@admin_edit_student'
]);
Route::post('/admin-student/update/{student_id}', [
	'as'=> 'admin_update_student',
	'uses'=> 'admin@admin_update_student'
]);
Route::get('/admin-pc/edit/{pc_id}/{room}', [
	'as'=> 'admin_pc_edit',
	'uses'=> 'admin@admin_pc_edit'
]);
Route::post('/admin-pc/update/{pc_id}/{room}', [
	'as'=> 'admin_pc_update',
	'uses'=> 'admin@admin_pc_update'
]);
Route::get('/admin-settings', [
	'as'=> 'admin_settings',
	'uses'=> 'admin@admin_settings'
]);
Route::post('/admin-update-settings', [
	'as'=> 'admin_update_settings',
	'uses'=> 'admin@admin_update_settings'
]);
