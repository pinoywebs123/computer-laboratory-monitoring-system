                    ...
                    <div class="col-lg-12">
                       ...
                       <div class="panel panel-info">
                            <div class="panel-heading">
                                <h1>Staff List</h1>
                                <button class="btn btn-danger" data-toggle="modal" data-target="#addStudent"><i class="glyphicon glyphicon-retweet"></i>New Staff</button>
                            </div>
                                    ...
                                    <tbody>
                                        @foreach($staffs as $staff)
                                            <tr>
                                                ...
                                                <td>{{$staff->email}}</td>
                                                <td>
                                                    @if($staff->role->name == 'cas5')
                                                        CAS 5
                                                    @elseif($staff->role->name == 'cas7')
                                                        CAS 7
                                                    @elseif($staff->role->name == 'cas8')
                                                        CAS 8
                                                    @endif
                                                </td>
                        ...
                        <form action="{{route('add_staff')}}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <select name="role" required="">
                                    <option value="2">CAS 5</option>
                                    <option value="3">CAS 7</option>
                                    <option value="4">CAS 8</option>
                                </select>
