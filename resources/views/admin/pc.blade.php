        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row" style="margin-bottom: 10px">
                    <div class="col-lg-12">
                       <h1>Pc's</h1>
                        <button class="btn btn-danger" data-toggle="modal" data-target="#addPc"><i class="glyphicon glyphicon-retweet"></i> New PC</button>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="{{route('addPc')}}" method="post">
                            ...
                            <div class="input-group">
                                <span class="input-group-addon" id="addon1">Room</span>
                                <select name="room" class="form-control" required="">
                                    
                                    <option value="2"><strong>CAS 5</strong></option>
                                    <option value="3"><strong>CAS 7</strong></option>
                                    <option value="4"><strong>CAS 8</strong></option>
                                </select>
                            </div>
                            <div class="input-group">
                                <span class="input-group-addon" id="addon1"><i class="glyphicon glyphicon-blackboard"></i></span>
